            ...
            Container(
              ...
              child: InkWell(
                ...
                child: Align(
                  ...
                  child: Text(
                    "Home",
                    style: TextStyle(fontWeight: (widget.pageName == "Home") ? FontWeight.bold : FontWeight.normal, fontSize: 16),
                  ),
                ),
                // style: buttonStyle,
              ),
            ...
            Container(
              ...
              child: InkWell(
                ...
                child: Align(
                  ...
                  child: Text(
                    "Calendar",
                    style: TextStyle(fontWeight: (widget.pageName == "Calendar") ? FontWeight.bold : FontWeight.normal, fontSize: 16),
                  ),
                ),
                // style: buttonStyle,
              ),
            ...
            Container(
              ...
              child: InkWell(
                ...
                child: Align(
                  ...
                  child: Text(
                    "Exercise Plan",
                    style: TextStyle(fontWeight: (widget.pageName == "Exercise Plan") ? FontWeight.bold : FontWeight.normal, fontSize: 16),
                  ),
                ),
                // style: buttonStyle,
              ),
            ...
            Container(
              ...
              child: InkWell(
                ...
                child: Align(
                  ...
                  child: Text(
                    "Progress",
                    style: TextStyle(fontWeight: (widget.pageName == "Progress") ? FontWeight.bold : FontWeight.normal, fontSize: 16),
                  ),
                ),
                //style: buttonStyle,
              ),
